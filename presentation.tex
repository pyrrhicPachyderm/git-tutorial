...
\begin{frame}{Looking at History}
	...
	\note[item]{
		...
		Now, suppose we want to go and hae a look at it.
...
\begin{frame}{Checkout Out}
	...
	\note[item]{
		...
		It will fail, and warn you, if it would overwrite any uncommited changes, so don't worry.
...
\begin{frame}{Refs}
	...
	\note[item]{
		...
		\texttt{\textasciitilde} is similar: it goes back a cetain number of parents.
	}
\end{frame}
